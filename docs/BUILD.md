...
make build VERSION=2.0.2      # produces both images (15-40 min)
```

Outputs:
```
packer/output/qemu/switchdex-2.0.2.qcow2   ← Proxmox / KVM
packer/output/switchdex-2.0.2.ova          ← VMware / VirtualBox
```
...
qemu-system-x86_64 -enable-kvm -m 4096 -smp 2 \
  -drive file=packer/output/qemu/switchdex-2.0.2.qcow2,format=qcow2 \
